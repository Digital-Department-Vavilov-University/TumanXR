...
> **Краткое описание:** Проект представляет собой симулятор (ПК и VR), предназначенный для обучения операторов-механизаторов эффективному и безопасному управлению самоходным опрыскивателем-разбрасывателем линейки «Туман» (производства «Пегас-Агро»).
...
* **Формирование базовых навыков:** Отработка вождения, маневрирования и позиционирования крупногабаритной спецтехники на виртуальном полигоне.
* **Технологические операции:** Освоение алгоритмов раскладывания/складывания штанг, настройки норм вылива и контроля расхода рабочей жидкости.
* **Изучение интерьера и приборов:** Знакомство с эргономикой кабины, физической приборной панелью, бортовым компьютером и элементами навигационного оборудования.
* **Безопасность производства:** Симуляция нештатных ситуаций (переворот, препятствия, поломка оборудования) в полностью безопасной виртуальной среде.
...
2. **Инициализация в среде:** Откройте корневую папку через Unity Hub. Обязательно используйте установленную версию редактора Unity `2022.3.53`.
3. **Импорт зависимостей:** Дождитесь окончания автоматического импорта пакетов OpenXR и внутренних ассетов проекта.
